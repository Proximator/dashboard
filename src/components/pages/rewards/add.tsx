    ...
    >
      ...
      <DialogContent>
        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
          ...
          <Grid item md={6} xs={12}>
            <FormControlLabel
              control={<Switch checked={values.isActive} onChange={() => setValues({ ...values, isActive: !values.isActive })} />}
              label="Active"
            />
          </Grid>
          <Grid item md={6} xs={12}>
            <FormControlLabel
              control={
                <Switch checked={values.isEngineering} onChange={() => setValues({ ...values, isEngineering: !values.isEngineering })} />
              }
              label="Engineering"
            />
          </Grid>
