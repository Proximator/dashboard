...
// const rowsInitial = [createData('07.10.2020', 1, 'Deal 1', '07.12.2021', true), createData('07.10.2020', 2, 'Deal 2', '07.12.2021', false)];
      ...
      <TableRow>
        ...
        {numSelected <= 0 &&
          headCells.map((headCell) => (
            <TableCell key={headCell.id} align={headCell.align} padding="none" sortDirection={orderBy === headCell.id ? order : false}>
              <TableSortLabel
...
const NewsList = () => {
  ...
  const { newsCollection, deleteNewsCollection } = useNewsCollection();
  ...
  const [rows, setRows] = useState(newsCollection);

  useEffect(() => {
    setRows(newsCollection);
  }, [newsCollection]);
  ...
  const handleSearch = (event) => {
    ...
    if (newString) {
      const newRows = rows.filter((row) => {
        ...
        const properties = ['id', 'createdAt', 'name', 'expiredAt', 'gender'];
                    ...
                    <TableCell align="center" sx={{ pr: 3 }}>
                      <Grid container>
                        ...
                        <Grid item xs={6} md={6} lg={6}>
                          <IconButton size="medium" onClick={() => deleteNewsCollection([row.id!])}>
                            <IconTrash />
                          </IconButton>
                        </Grid>
                      </Grid>
