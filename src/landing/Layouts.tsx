...
// import imgLayoutDarkGrid from '/images/landing/img-bg-grid-dark.svg';
                                    ...
                                    <img
                                        src={
                                            theme.palette.mode === 'dark'
                                                ? '/images/landing/img-bg-grid-dark.svg'
                                                : '/images/landing/img-lay-grid.png'
                                        }
                                        alt="Berry"
                                        style={{ width: '100%' }}
                                    />
                                    <LayoutImage src={'/images/landing/demo-dark.png'} alt="Berry" />
                                </LayoutImageWrapper>
                            </Grid>
                            <Grid item sm={6}>
                            ...
                            <Grid item sm={6}>
                                <LayoutImageWrapper>
                                    <img
                                        ...
                                        style={{ width: '100%' }}
                                    />
                                    <LayoutImage src={'/images/landing/demo-rtl.png'} alt="Berry" style={{ animationDelay: '1.5s' }} />
                                </LayoutImageWrapper>
                            </Grid>
                        </Grid>
                    </Grid>
                            ...
                            <Grid item sm={6}>
                                <LayoutImageWrapper>
                                    <img
                                        ...
                                        style={{ width: '100%' }}
                                    />
                                    <LayoutImage src={'/images/landing/demo-multi.png'} alt="Berry" style={{ animationDelay: '3s' }} />
                                </LayoutImageWrapper>
                            </Grid>
                            <Grid item sm={6}>
                                <LayoutContent
